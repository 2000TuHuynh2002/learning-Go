...
// the interface. Here we implement `geometry` on `rects`.
...
// named interface. Here’s a generic `measure` function taking advantage of this
...
// Sometimes it’s useful to know the runtime type of an interface value. One option
// is using a type assertion as shown here; another is a type `switch`.
