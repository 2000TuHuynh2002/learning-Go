// Here’s an example line filter in Go that writes a capitalized version of all
...
func main() {
	...
	// `Scan` method that advances the scanner to the next token; which is the next
	// line in the default scanner.
