...
// Plant will be mapped to XML. Similarly to the JSON examples, field tags contain
// directives for the encoder and decoder. Here we use some special features of
// the XML package: the `XMLName` field name dictates the name of the XML element
...
func main() {
	...
	// Emit XML representing our plant; using `MarshalIndent` to produce a more human-readable
	// output.
