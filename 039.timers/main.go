...
func main() {
	...
	// you want to wait, and it provides a channel that will be notified at that time.
	...
	// If you just wanted to wait, you could have used `time.Sleep`. One reason a
	// timer may be useful is that you can cancel the timer before it fires. Here’s
	// an example of that.
