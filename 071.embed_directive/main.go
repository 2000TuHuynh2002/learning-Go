...
// `embed` directives accept paths relative to the directory containing the Go source
// file. This directive embeds the contents of the file into the `string` variable
