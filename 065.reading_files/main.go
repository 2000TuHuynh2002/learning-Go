...
// Reading files requires checking most calls for errors. This helper will streamline
// our error checks below.
func check(e error) {
	if e != nil {
		panic(e)
	}
...
func main() {
	// Perhaps the most basic file reading task is slurping a file’s entire contents
	// into memory.
	...
	// For example, reads like the ones above can be more robustly implemented with
	// `ReadAtLeast`.
	...
	// Close the file when you’re done (usually this would be scheduled immediately
