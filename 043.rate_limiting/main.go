...
func main() {
	...
	// of incoming requests. We’ll serve these requests off a channel of the same
	// name.
	...
	// preserving the overall rate limit. We can accomplish this by buffering our
	// limiter channel. This `burstyLimiter` channel will allow bursts of up to 3
	// events.
	...
	// Every 200 milliseconds we’ll try to add a new value to `burstyLimiter`, up
	// to its limit of 3.
	go func() {
	...
	// Now simulate 5 more incoming requests. The first 3 of these will benefit from
